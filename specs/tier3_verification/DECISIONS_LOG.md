...
|---|---|
| `model_gateway.py` | DEC-015, DEC-017, DEC-019, DEC-020, OPEN-01, DEC-058 (`walk_chain()` N-tier engine, bounded streaming fallback), DEC-061 (per-tier `min_max_tokens` floor) |
...
| `config_inference_chains.py`, `providers_cloudflare.py`, `providers_gemini.py`, `inference_health_handler.py`, `check_inference_provider_health.py` (all new) | DEC-058, DEC-061 (`config_inference_chains.py` only — `min_max_tokens` field, judge tier 2 override) |
...
| `vault_client.py`, `scripts/setup_vault.py`, `aegis-vault` (docker-compose) | DEC-046, DEC-051, OPEN-09, DEC-060 (OPEN-14 — repurpose direction chosen, not yet implemented) |
