...
|---|---|
| `model_gateway.py` | DEC-015, DEC-017, DEC-019, DEC-020, OPEN-01, DEC-058 (`walk_chain()` N-tier engine, bounded streaming fallback) |
...
| `config_inference_chains.py`, `providers_cloudflare.py`, `providers_gemini.py`, `inference_health_handler.py`, `check_inference_provider_health.py` (all new) | DEC-058 |
